<x-layout>
    ...
    <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <form class="p-5 border shadow" method="POST" action="{{route('comic.update', compact('comic'))}}" enctype="multipart/form-data">
                    ...
                    <div class="mt-3">
                        ...
                        <img style="width: 300px "src="{{Storage::url($comic->cover)}}" alt="">
                    </div>
                    
                    <div class="mb-3">
                        <label for="name" class="form-label">Nome della serie</label>
                        <input type="text" name="name" class="form-control" id="name" value="{{$comic->name}}">
                    </div>
                    
                    <div class="mb-3">
                        <label for="publisher" class="form-label">Nome della casa di stampa</label>
                        <input type="text" name="publisher" class="form-control" id="publisher" value="{{$comic->publisher}}">
                    </div>
